...
s.description  = <<-DESC
📤 `Drawer View` is a custom UI component replication of Apple's `Apple Music` player and `Shortcuts` components view
DESC

s.homepage     = "https://github.com/jVirus/drawer-view"
...
s.source_files = "drawer-view/**/*.swift"
# s.exclude_files = "Classes/Exclude"

# s.public_header_files = "drawer-view/**/*.h"
